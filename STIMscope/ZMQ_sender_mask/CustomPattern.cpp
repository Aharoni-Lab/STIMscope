// =====================================================================
// AUDIT STATUS: DORMANT (LIVE-DEFER, L3-projector LIGHT-tier )
//
// This standalone C++ pattern sender has NO build system invocation in
// the current codebase (no Dockerfile / Makefile / build.sh / launcher
// references). Source-only file; never compiled.
//
// Functionality duplicates zmq_mask_sender.py (Python equivalent).
// If you want a C++ bench-test pattern sender, this file is a starting
// point — but it needs (a) a build rule added, (b) the --rect-w/-h
// flags either implemented or removed from usage(), (c) filename typo
// fixed ("Cusom" → "Custom").
//
// Spec: docs/specs/L3_projector/CusomPattern.md
// Sibling LIVE-DEFER modules: experiment_db.py, pipeline_runner.py.
//
// DO NOT add a build rule for this file in new production code without
// first promoting it to FULL-tier audit. Promotion criterion: any new
// build invocation OR launcher/CI reference.
// =====================================================================
